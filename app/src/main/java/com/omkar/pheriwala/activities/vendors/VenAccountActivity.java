...
public class VenAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ven_account);

        btn_log = findViewById(R.id.btn_ven_login);
        btn_reg = findViewById(R.id.btn_ven_reg);
                        ...
                        mAuth.signInWithEmailAndPassword(mail,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(VenAccountActivity.this,"Login Success",Toast.LENGTH_LONG).show();
//                            Intent i = new Intent(getContext(), MainActivity.class);
//                            startActivity(i);

                                    Intent i = new Intent(VenAccountActivity.this, VenHomeActivity.class);
                                    startActivity(i);
...
//                edtadd = v.findViewById(R.id.edtadd);
                ...
                mAuth.createUserWithEmailAndPassword(mail,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(VenAccountActivity.this,"success, please login",Toast.LENGTH_LONG).show();
...
//                Products products = new Products();
                            ...
                            databaseReference.child("Vendor").child(id).child("username").setValue(username);
                            databaseReference.child("Vendor").child(id).child("email").setValue(mail);
                            databaseReference.child("Vendor").child(id).child("phone").setValue(phone);
                            databaseReference.child("Vendor").child(id).child("address").setValue(add);
